...
namespace ConfigurationComponentBaseDLL
{
    public class DLLConfigurationComponentBase
    {
		public static void SaveInConfig(FileConfigurationProvider fConfigurationProvider)
		{
